    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="sub_container">
                <p class="intro_text">Ever since I was a child, I was always interested in space. The intrigue of what's out there, what amazing things we've never seen. How vast and empty space is, really makes you think. Try to imagine where space ends. Seriously, lean back, close your eyes and think about it. I've done it many times and it's always astounding how it's not even comprehensable. Hopefully you enjoy space as much as me and enjoy the little site I've put together! </p>
                <div class="three_boxes">
                    <section>
                    <h2><a href="facts">Space Facts!</a></h2>
                    <hr class="intro-divider">
                    <p>Did you know 99% of our solar system's mass is the sun? That's insane, check out the Space Facts page for more great stuff!</p>
                </section>

                <section>
                    <h2><a href="iss">I.S.S.</a></h2>
                    <hr class="intro-divider">
                    <p>The International Space Station's is the largest artificial body in orbit and can be seen with the naked eye from Earth's surface. To learn visit my I.S.S.. page!</p>
                </section>
